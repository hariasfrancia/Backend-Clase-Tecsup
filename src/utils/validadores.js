...
const verificarToken = (token) => {
    try { // el metodo usara la contraseña, para ver si la token es la correcta, si tiene tiempo de ida y si es una token valida (tiene una buen formato) caso contrario saltara el catch
